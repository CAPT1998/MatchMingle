...
class Filteruserprofiles extends StatefulWidget {
  Filteruserprofiles({
    required this.index,
    required this.id,
    required this.token,
  ...
  @override
  State<Filteruserprofiles> createState() => _ExampleCardState();
}

class _ExampleCardState extends State<Filteruserprofiles> {
  int? age;
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer3<AuthProvider, LimitUserAccessProvider, LikeProvider>(
      builder: (context, authprovider, LimitUserAccessProvider, likeProvider,
          child) {
        return Scaffold(
                        ...
                        background: ClipRRect(
                          child: Stack(
                            children: [
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.fromLTRB(20, 0, 20, 489),
                                child: Column(
